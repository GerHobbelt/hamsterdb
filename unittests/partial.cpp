...
public:
    ...
    void findGapsAtEndTestSmall(void)
    {
        findTest(0, 50, 100);
    }

    void findGapsAtEndTestBig(void)
    {
        findTest(0, 500, 1000);
    }

    void findGapsAtEndTestBigger(void)
    {
        findTest(0, 5000, 10000);
    }

    void findGapsAtEndTestBiggest(void)
    {
        findTest(0, 50000, 100000);
    }

    void findGapsAtEndTestSuperbig(void)
    {
        findTest(0, 500000, 1000000);
    }

    void findGapsAtBeginningTestSmall(void)
    {
        findTest(50, 50, 100);
    }

    void findGapsAtBeginningTestBig(void)
    {
        findTest(500, 500, 1000);
    }

    void findGapsAtBeginningTestBigger(void)
    {
        findTest(5000, 5000, 10000);
    }

    void findGapsAtBeginningTestBiggest(void)
    {
        findTest(50000, 50000, 100000);
    }

    void findGapsAtBeginningTestSuperbig(void)
    {
        findTest(500000, 500000, 1000000);
    }

    void findGapsTestSmall(void)
    {
        findTest(50, 50, 200);
    }

    void findGapsTestBig(void)
    {
        findTest(500, 500, 2000);
    }

    void findGapsTestBigger(void)
    {
        findTest(5000, 5000, 20000);
    }

    void findGapsTestBiggest(void)
    {
        findTest(50000, 50000, 200000);
    }

    void findGapsTestSuperbig(void)
    {
...
public:
    ...
    void invalidInsertParametersTest(void)
    {
        ham_key_t key;
        ham_record_t rec;
        ham_u8_t buffer[500];
    ...
    void invalidFindParametersTest(void)
    {
        ham_key_t key;
        ham_record_t rec;
        ham_u8_t buffer[500];
