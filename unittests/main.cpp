...
#if (HAM_LEAN_AND_MEAN_FOR_PROFILING_LEVEL == 1)
    i = (i & 0x0000FFFF) | _CRTDBG_CHECK_EVERY_1024_DF;
#elif (HAM_LEAN_AND_MEAN_FOR_PROFILING_LEVEL <= 0)
...
//    (void)_calloc_dbg(1, 1, _CLIENT_BLOCK, __FILE__, __LINE__);
    ...
    //add_argv_elem(&new_argc, &new_argv, "FreelistV1Test");
    //add_argv_elem(&new_argc, &new_argv, "FreelistV2Test");
    //add_argv_elem(&new_argc, &new_argv, "FreelistV2Pagesize3072Test");
...
#   else
    ...
    if (access("../../unittests/data/dupe-endian-test-open-database-be.hdb", 0) != -1)
    {
        testrunner::get_instance()->inputdir("../../unittests/");
    }
    else
...
"unittests [options]\n"
"\n"
"Executes the suite of HamsterDB unittests. The default is to execute all\n"
...
"Examples:\n"
"\n"
"    :getDefaultDbParamsTest\n"
"~ execute the APIv110Test::getDefaultDbParamsTest unittest. (The 'APIv110Test'\n"
"  fixture is the only fixture with that test name.)\n"
" \n"
"    APIv110Test::getDefaultDbParamsTest\n"
"~ execute the APIv110Test::getDefaultDbParamsTest unittest.\n"
);
                        return r;
                    }
                    if (option_name == "--list")
